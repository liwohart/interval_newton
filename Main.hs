...
--1 err = 1e-10, steps = 4, answer = 1.4142135623730951 ... 1.4142135623730951
--
  (1 ... 2,
   \x -> singleton $ x^2 - x - 1,
   \x -> 2*x - singleton 1,
...
--2 err = 1e-10, steps = 4, answer = 1.6180339887493835 ... 1.6180339887504658
--
  (1 ... 3,
   \x -> singleton $ x^2 - 3,
   \x -> 2*x,
...
--3 err = 1e-10, steps = 4, answer = 1.7320508075645042 ... 1.7320508075739158
--
  ((1 ... 2),
   \x -> singleton $ (x - 1) * x**2,
   ...
   "x^3 - x^2",
   Just $ singleton 1),
--4 err = 1e-10, steps = 6, answer = 1.0 ... 1.000000000000001
--
  ((0.5 ... 2),
   \x -> singleton $ x^2 - 1,
   \x -> 2 * x,
   "x^2 - 1",
   Just $ singleton 1),
--5 err = 1e-10, steps = 5, answer = 1.0 ... 1.0
--
  (2.5 ... 3,
   ...
   Nothing),
--6 err = 1e-10, steps = 5, answer = 2.6281878450866234 ... 2.6281878450866234
--
  ((0.75 ... 2),
   ...
   "x^3 - x - 1",
   Nothing),
--7 err = 1e-10, steps = 5, answer = 1.324717957244746 ... 1.324717957244746
--
  ((2 ... 3),
   \x -> singleton $ (x - 1)^2 + 1,
   ...
   "x^2 - 2x + 2",
   Just empty),
--9 err = 1e-10, steps = 1, answer = Empty
--
  ((-3 ... (-2)),
   ...
   "2x^3 + 3x^2 - 2x + 8",
   Nothing),
--10 err = 1e-10, steps = 4, answer = -2.092193585704187 ... -2.0921935857034795
--
  ((-0.25 ... 0.5),
   \x -> singleton $ (1 - x^2)*x,
   ...
   "x - x^3",
   Just $ singleton 0),
--11 err = 1e-10, steps = 3, answer = 0.0 ... 0.0
--
  ((0.75 ... 2),
   \x -> singleton $ x^3 - x,
   \x -> (singleton 3)*(x!^2) - (singleton 1),
   "x^3 - x",
   Just $ singleton 1),
--14 err = 1e-10, steps = 5, answer = 0.9999999999999999 ... 1.0000000000000002
--
  (7 ... 8,
...
--17 err = 1e-10, steps = 4, answer = 7.741657386773941 ... 7.741657386773941
--
  (1 ... 2,
   \x -> (singleton x) !^ 2 - (2 ... 3),
   \x -> 2*x,
   "x^2 - [2,3]",
   Just $ sqrt 2 ... sqrt 3),
--0 err = 1e-10, steps = 10, answer = 1.4031881762974567 ... 1.7556818181818181
--
  ((1 ... 5),
   \x -> (singleton x) !^ 2 - (4 ... 9),
   \x -> 2 * x,
   "x^2 - [ 4 , 9 ]",
   Just $ 2 ... 3),
--8 err = 1e-10, steps = 3, answer = 2.0 ... 3.0
--
  ((4.5 ... 20),
   ...
   Nothing),
--12 err = 1e-10, steps = 1, answer = 4.5 ... 20.0
--
  ((-2 ... 2),
   \x -> (1 ... 2)*(singleton x) !^ 3,
   \x -> (3 ... 6)*x !^ 2,
...
--
  (singleton 20 * (-10 ... 14),
   ...
   "[1,4]x + [-4,1]",
   Just $ (-1 ... 4)),
--15 err = 1e-10, steps = 2, answer = -2.0 ... 4.0
--
  ((5 ... 8),
   ...
   "[0.5,3]x^2 + [-4,1]x + [1,3]",
   Just $ 5 ... (4 + sqrt 14))]
--16 err = 1e-10, steps = 2, answer = 5.0 ... 8.375
